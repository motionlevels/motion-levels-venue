// Code generated by 'make motion-go-seeds' from game-engine/internal/games/authored/nativegames/memoriav2go/game.go. DO NOT EDIT.
export const memoriaV2MotionGoSource = String.raw`// Code generated from game-engine/internal/games/authored/nativegames/memoriav2go/game.go; edit the engine copy and run 'make motion-go-seeds'.
package main
