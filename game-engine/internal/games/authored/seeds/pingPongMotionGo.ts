// Code generated by 'make motion-go-seeds' from game-engine/internal/games/authored/nativegames/pingpongmotion/game.go. DO NOT EDIT.
export const pingPongMotionGoSource = String.raw`// Code generated from game-engine/internal/games/authored/nativegames/pingpongmotion/game.go; edit the engine copy and run 'make motion-go-seeds'.
package main
